...
$activeSheet->setCellValue('A1', 'กำลังดำเนินการ')
  ...
  $i = 3;
  $sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_Status = 1 ORDER BY MRA_Priority DESC, MRA_Datetime DESC";
  ...
  header('Content-Disposition: attachment;filename="แจ้งซ่อมใหม่.xlsx"');

...
include("leader_countstatus.php");
// $count_status = 0;
...
<?php include("../front/leader_engineer_menubar.php"); ?>
<!-- navbar -->
...
<div class="container col-sm-6">
	<br>
	<h3>การแจ้งเตือนล่าสุดของหน่วยงาน <?php echo $_SESSION["WG_WorkUnitName"]; ?></h3><br>
...
<!--	รายการแจ้งซ่อม, วันที่แจ้งซ่อม, รายละเอียด, สถานะ, จัดการ-->
	<div class="divtable accordion-xs">
		...
		<div class="tr headings">
			...
			$num = 0;
			$wg_id = $_SESSION["WG_ID"];
			$sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_WorkUnitID = '$wg_id'";

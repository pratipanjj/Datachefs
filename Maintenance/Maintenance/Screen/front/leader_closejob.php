...
<!--	ผลการตรวจรับงาน-->
	<div class="divtable accordion-xs">
		...
		while ($row1 = sqlsrv_fetch_array($result1))
		{
			...
			echo '<div class="td score">' . $row1["MRC_Score"] . '</div>';
			echo '</div>';
			echo '</div>';
			echo '</div>';
	...
	<div class="row">
		<form class="col-sm-4" action="../backend/action_leader_closejob.php" method="post">
			...
			<div class="custom-control custom-radio">
				<input type="radio" class="custom-control-input" id="defaultInline1" name="work" value="ปิดงานซ่อมได้" required>
				<label class="custom-control-label" for="defaultInline1">ปิดงานซ่อมได้</label>
			</div>
			<br>

			<div class="custom-control custom-radio">
				<input type="radio" class="custom-control-input" id="defaultInline2" name="work" value="ปิดงานซ่อมไม่ได้ / มอบหมายงานให้ช่างคนใหม่" required>
				<label class="custom-control-label" for="defaultInline2">ปิดงานซ่อมไม่ได้ / มอบหมายงานให้ช่างคนใหม่</label>
			</div>
			<br>
			...
			<div class="text-right"><input type="submit" class="btn btn-light-blue" name="submit" value="บันทึก"/></div>
		</form>

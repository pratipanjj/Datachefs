...
<div>
	...
	<div class="container col-sm-8"><br>
		<div class="row">
		<h3>ดำเนินการแล้ว / รอตรวจงาน&nbsp;&nbsp;&nbsp;</h3>
		<a href="../../PHPExcel/export-excel-leader3.php" class="btn btn-outline-success" target="_blank">excel</a>
	</div><br></div>
	...
	<div class="container-fluid">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item" style="display:inline-block;">
				<a class="nav-link active" href="leader_index_status3.php"><img src="../../img/icon/status3.png" width="15px" height="15px"><span class="badge badge-danger"><?php echo $count_status3; ?></span></a>
			</li>
			<li class="nav-item" style="display:inline-block;">
	...
	<div class="divtable accordion-xs">
		...
		$sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_Status = 3 ORDER BY MRA_Priority DESC OFFSET " . $s_page . " ROWS FETCH NEXT " . $e_page . " ROWS ONLY";
		...
		if (sqlsrv_has_rows($result) != 0)
		{
			...
			while ($row = sqlsrv_fetch_array($result))
			{
				...
				echo '<div class="td effect">' . $classMySec->encode($row["MRA_Effect"]) . '</div>';

...
<div class="container-fluid">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item" style="display:inline-block;">
			<a class="nav-link active" href="user_index_status4.php"><img src="../../img/icon/status4.png" width="15px" height="15px"><span class="badge badge-danger"><?php echo $count_status4; ?></span></a>
		</li>
		<li class="nav-item" style="display:inline-block;">
...
<!--	รายการแจ้งซ่อม, วันที่แจ้งซ่อม, รายละเอียด, สถานะ, จัดการ-->
	<div class="divtable accordion-xs">
			...
			// $sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_WorkUnitID = '$wg_id' AND MRA_Status = 4";

...
<div>
	...
	<div class="divtable accordion-xs">
		...
		$sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_Status = 1 ORDER BY MRA_Priority DESC OFFSET " . $s_page . " ROWS FETCH NEXT " . $e_page . " ROWS ONLY";

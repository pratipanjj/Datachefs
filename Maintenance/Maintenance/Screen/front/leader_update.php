...
// ------------------------------------20/01/2020 สร้างไฟล์ include แทน by POP----------------------------------
...
<div class="container col-sm-6">
	...
	<p><span class="error"><b> * </b><?php echo "จำเป็นต้องกรอกข้อมูล";?></span></p>
		<form action="../backend/action_leader_update.php" method="post" enctype="multipart/form-data" accept-charset="utf-8" id="savestate">

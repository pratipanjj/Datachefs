...
<div class="container-fluid">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item" style="display:inline-block;">
			<a class="nav-link active" href="user_index_status3.php"><img src="../../img/icon/status3.png" width="15px" height="15px"><span class="badge badge-danger"><?php echo $count_status3; ?></span></a>
		</li>
		<li class="nav-item" style="display:inline-block;">
		...
		<li class="nav-item" style="display:inline-block;">
			<a class="nav-link" href="user_index_status5.php"><img src="../../img/icon/status5.png" width="15px" height="15px"><span class="badge badge-danger"><?php echo $count_status5; ?></span></a>
		</li>
		<hr>
	</ul>
</div><br>
...
<!--	รายการแจ้งซ่อม, วันที่แจ้งซ่อม, รายละเอียด, สถานะ, จัดการ-->
	<div class="divtable accordion-xs">
			...
			// $sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_WorkUnitID = '$wg_id' AND MRA_Status = 3";

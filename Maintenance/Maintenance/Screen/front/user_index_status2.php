...
<div class="container-fluid">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item" style="display:inline-block;">
			<a class="nav-link active" href="user_index_status2.php"><img src="../../img/icon/status2.png" width="15px" height="15px"><span class="badge badge-danger"><?php echo $count_status2; ?></span></a>
		</li>
		<li class="nav-item" style="display:inline-block;">
	...
	<div class="divtable accordion-xs">
		<?php
			...
			if(isset($_SESSION["WG"]) || isset($_GET['workgroup'])){
				...
				$sql = "SELECT * FROM MaintenanceRepairAdd WHERE MRA_WorkUnitID = '$wg_id' AND MRA_Status = 2";
			}else{
